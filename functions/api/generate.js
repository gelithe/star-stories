...
1. START IN A REAL MOMENT the child would recognise from their own life — a birthday where everyone is loud, a new school, a little brother who breaks the tower, waiting to be picked for a team, a dark bedroom, a friend who walked off with someone else. Something ORDINARY and specific, with real rooms, people and things. The symbolic landscape (the hill, the fog) may grow OUT of that moment, but the book must not open in a dreamworld — the child has to think "that happens to me" on page one.
